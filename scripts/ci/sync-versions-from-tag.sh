...
perl -i -pe 's/ARG APP_VERSION=[^\s]+/ARG APP_VERSION='"$VERSION"'/' scraper/Dockerfile notification-service/Dockerfile notification-service/Dockerfile.jvm dashboard/Dockerfile
